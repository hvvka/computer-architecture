...
void rozmycie(unsigned int Width,unsigned char* data,int sizeOfData)
{
int count,i;
...
rozmycie(Header.biWidth*3,data,IMAGE_SIZE);
fwrite(header,1,nread2,f);
fseek(f,1,nread2);
fwrite(data,1,nread,f);
fclose(f);
break;
case 2:
